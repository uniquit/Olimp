...
= 1.0.5 - Oct 06 2021 =
* Fix: Include file issue when child theme activated
* Update: block widget heading style updated & made same to classic widget heading
* Update: Minor CSS updated

= 1.0.4 - Sep 08 2021 =
* Fix: Removed extra ; from style, blocks and editor style
* Update: CSS files

= 1.0.3 - Jul 23 2021 =
* Fix: Site branding alignment issue in mobile devices
