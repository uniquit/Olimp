...
/**
 * Class businessexpo_Customize_Color_Control
 */
class businessexpo_Customize_Color_Control extends businessexpo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'businessexpo-color';
