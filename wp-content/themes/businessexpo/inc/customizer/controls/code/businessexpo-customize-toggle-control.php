...
/**
 * Class businessexpo_Customize_Toggle_Control
 */
class businessexpo_Customize_Toggle_Control extends businessexpo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'businessexpo-toggle';
