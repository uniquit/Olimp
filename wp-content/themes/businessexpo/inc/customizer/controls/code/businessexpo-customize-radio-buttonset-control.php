...
/**
 * Class businessexpo_Customize_Radio_Buttonset_Control
 */
class businessexpo_Customize_Radio_Buttonset_Control extends businessexpo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'businessexpo-radio-buttonset';
