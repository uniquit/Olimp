...
/**
 * Class businessexpo_Customize_Radio_Image_Control
 */
class businessexpo_Customize_Radio_Image_Control extends businessexpo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'businessexpo-radio-image';
