...
<main id="maincontent" role="main">
					          ...
					          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
					            ...
					            <div class="carousel-caption">
					              <div class="inner_carousel">
					                 <h1 class="wow swing" data-wow-duration="3s"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
					                <p class="wow swing" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_ecommerce_shop_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_ecommerce_shop_slider_excerpt_number','30')))); ?></p>
					                <?php if( get_theme_mod('vw_ecommerce_shop_slider_button_text','READ MORE') != ''){ ?>
						                <div class="more-btn wow swing" data-wow-duration="3s">            
	...
	<?php if( get_theme_mod('vw_ecommerce_shop_maintitle') != ''){ ?>
		<section class="our-products wow wobble delay-1000" data-wow-duration="1s">
			<div class="container">
