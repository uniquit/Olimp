...
if (!class_exists('Spiko_About_Page')) {
	class Spiko_About_Page {
		...
		function __construct() {
			...
			add_action( 'spiko_info_screen', array( $this, 'one_click_demo_actions' ), 	50 );
	    ...
	    public function one_click_demo_actions() {
			require_once( SPIKO_TEMPLATE_DIR . '/admin/tab-pages/one-click-demo-import.php' );
		}
		...
		public function get_tabs_array() {
		    ...
		    $tabs_array[]	= 	array(
					'link'      => 'one_click_demo',
					'name'      => esc_html__('One Click Demo Import', 'spiko' ),
			);
