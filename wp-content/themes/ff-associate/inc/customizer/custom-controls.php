<?php
/**
 * FF Associate Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class FF_Associate_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_image_checkbox';
	 ...
	 */
	 class FF_Associate_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_text_radio_button';
	 ...
	 */
	class FF_Associate_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_image_radio_button';
	 ...
	 */
	class FF_Associate_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_simple_notice';
	 ...
	 */
	class FF_Associate_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_slider_control';
	 ...
	 */
	class FF_Associate_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_toggle_switch';
	 ...
	 */
	class FF_Associate_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_sortable_repeater';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->button_labels = wp_parse_args( $this->button_labels,
				array(
					'add' => esc_html__( 'Add', 'ff-associate' ),
				)
			);
		}
	 ...
	 */
	class FF_Associate_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_dropdown_select2';
	 ...
	 */
	class FF_Associate_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = FF_Associate_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 *
	 */
	class FF_Associate_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff-associate-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="ff_associate_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	class FF_Associate_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ff_associate_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['ff_associatetinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['ff_associatetinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['ff_associatemediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class FF_Associate_Note_Control extends WP_Customize_Control {
		public $type = 'ff_associate_description';
	 ...
	 */
	if ( ! function_exists( 'ff_associate_url_sanitization' ) ) {
		function ff_associate_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'ff_associate_switch_sanitization' ) ) {
		function ff_associate_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'ff_associate_radio_sanitization' ) ) {
		function ff_associate_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'ff_associate_text_sanitization' ) ) {
		function ff_associate_text_sanitization( $input ) {
	 ...
	 */
	function ff_associate_sanitize_select( $input, $setting ) {
	 ...
	 */
	function ff_associate_sanitize_map_code( $input ) {
		// allow iframe.
