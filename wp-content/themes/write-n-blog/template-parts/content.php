				...
				<div class="entry-content">
					...
					the_excerpt( sprintf(
						wp_kses(
							...
							__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'write-n-blog' ),
							array(
								'span' => array(
									'class' => array(),
									),
					...
					wp_link_pages( array(
						'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'write-n-blog' ),
						'after'  => '</div>',
						) );
						?>
						<div class="read-more-blogfeed">
							<a href="<?php the_permalink() ?>"><?php echo __('Read More', 'write-n-blog') ?></a>
						</div>
					</div><!-- .entry-content -->
